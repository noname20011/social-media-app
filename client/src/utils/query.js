...
export const userCreatePinsQuery = (userId) => {
    const query = `*[_type == 'pin' && userId == '${userId}'] | order(createAt desc){
        image {
            asset -> {
                url
            }
...
export const userSavedPinsQuery = (userId) => {
    const query = `*[_type == 'pin' && '${userId}' in save[].userId] | order(createAt desc){
        image {
            asset -> {
                url
            }
